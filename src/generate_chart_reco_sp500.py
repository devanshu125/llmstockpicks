...
# fetch components of sp500
link = (
    "https://en.wikipedia.org/wiki/List_of_S%26P_500_companies#S&P_500_component_stocks"
)
sp500_df = pd.read_html(link, header=0)[0]
...
MODEL_NAME = "google/gemini-2.0-flash-001" #"google/gemini-2.0-flash-lite-preview-02-05:free"
...
results_df.to_csv("weekly_recommendations_week2.csv", index=False)
